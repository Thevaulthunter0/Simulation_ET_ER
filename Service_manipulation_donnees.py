...
class service_manipulation_donnees:
    ...
    @staticmethod
    def unpack_paquet_de_donnees(pack_data):  # unpack_N_DATA_ind
        """
    ...
    # ====== N_CONNECT ======
    @staticmethod
    def pack_N_CONNECT_REQ(_numCon, _typePaquet, _AddrSrc, _AddrDest):
        """
    ...
    def pack_N_CONNECT_IND(_numCon, _AddrSrc, _AddrDest):
        """
    ...
    @staticmethod
    def pack_N_CONNECT_RESP(_numCon, _AddrSrc, _AddrDest):
        """
    ...
    @staticmethod
    def unpack_N_CONNECT_RESP(data):
        """
    ...
    @staticmethod
    def pack_N_CONNECT_CONF(_numCon, _AddrSrc, _AddrDest):
        """
        Définition : Empaquetage des données de communication établie.
        Input : _numCon (int), _AddrSrc (int), _AddrDest (int)
        Output : (bytes) Paquet empaqueté
    ...
    @staticmethod
    def unpack_N_CONNECT_CONF(data):
        """
        Définition : Dépaquetage des données de communication établie.
        Input : data (bytes)
        Output : (_numCon (int), _AddrSrc (int), _AddrDest (int))
